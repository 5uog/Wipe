...
const ADJECTIVES = [
    "quiet", "lucid", "steady", "subtle", "calm", "brisk", "gentle", "bold", "clear", "sharp", "patient",
    "nimble", "humble", "bright", "mellow", "witty", "sincere", "stellar", "amber", "silver", "copper", 
    "midnight", "velvet", "crisp", "elegant", "faint", "vivid", "lithe", "keen", "kind", "sable", "ivory",
    "sage", "vernal", "autumn", "winter", "summer", "atomic", "cosmic", "neon", "lunar", "solar", "aerial",
    "tidal", "rational", "tactile", "patient", "resolute", "modest", "frank", "radiant", "rare", "sturdy",
    "precise", "prudent", "honest", "crafty", "silent", "gentle", "daring", "balanced", "measured",
    "frozen", "warm", "cool", "dry", "stormy", "opal", "jade", "azure", "crimson", "golden", "obsidian",
    "granite", "paper", "carbon", "ceramic", "linear", "smooth", "sparse", "dense", "clean", "soft", "hard",
    "exact", "finite", "open", "sealed", "magnetic", "electric", "kinetic",
];

const NOUNS = [
    "lynx", "otter", "raven", "falcon", "whale", "tiger", "fox", "wolf", "bear", "shark", "orca", "owl",
    "panther", "dolphin", "sparrow", "heron", "ibis", "manta", "gecko", "viper", "puma", "badger", "bison",
    "yak", "koala", "lemur", "pigeon", "coyote", "wren", "swift", "comet", "nebula", "quasar", "photon",
    "matrix", "vector", "cipher", "signal", "kernel", "node", "atlas", "compass", "harbor", "orchard",
    "canyon", "delta", "fjord", "glacier", "meadow", "basil", "pepper", "ginger", "cedar", "maple",
    "willow", "granite", "marble", "cobalt", "helium", "argon", "neon", "saturn", "jupiter", "mercury",
    "venus", "pluto", "aurora", "ember", "shadow", "ripple", "echo", "tempo", "chord", "canvas", "ink", 
    "paper", "lens", "prism", "relay", "anchor", "bridge", "gate", "vault", "thread", "weave", "forge",
];
